...
def get_metadata(text):
    """Detects Category, Emojis, and ALL mentioned towns for multi-tagging."""
    ...
    # Fallback to "County News" if no specific town is identified
    if not town_tags:
...
async def process_news():
    """Main logic: Fetches news, cleans data, and deduplicates with multi-tags."""
    final_news = []
    seen_hashes = set() 
